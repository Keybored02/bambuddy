export default {
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      systemQueued: 'Config queued. Reboot the SpoolBuddy device to apply new backend/auth values.',
      rebootDevice: 'Reboot Device',
      rebootHelp: 'Reboot manually on the device host: sudo reboot',
      rebootHint: 'After saving, reboot the SpoolBuddy device from the host OS when ready.',
      nfcDiagnostic: 'NFC Diagnostic',
      scaleDiagnostic: 'Scale Diagnostic',
      readTagDiagnostic: 'Read Tag Diagnostic',
      testNfc: 'Test reader',
      testScale: 'Test accuracy',
      testReadTag: 'Run read_tag.py',
