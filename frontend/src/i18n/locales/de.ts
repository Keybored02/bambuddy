export default {
  ...
  // AMS History
  amsHistory: {
    recordingInfo: 'Daten werden alle 5 Minuten aufgezeichnet, solange der Drucker verbunden ist',
  },

  // Nozzle Temperature History
  nozzleHistory: {
    recordingInfo: 'Daten werden erfasst, wenn Temperatur-Updates eingehen',
  },
